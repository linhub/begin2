		...
		foreach ($comments as $my_comment) {
			if ($my_comment->comment_author_email != $my_email) {
				...
				<li>
					...
					<span class="comment_author"><?php echo $my_comment->comment_author; ?>:</span><br/>
					<a href="<?php echo get_permalink($my_comment->comment_post_ID); ?>#anchor-comment-<?php echo $my_comment->comment_ID; ?>" title="该评论来自: <?php echo get_the_title($my_comment->comment_post_ID); ?>" rel="external nofollow">
